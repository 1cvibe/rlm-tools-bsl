...
34 BSL-специфичных хелпера + 8 стандартных I/O + 2 LLM = **44 хелпера**: навигация по модулям, парсинг процедур, граф вызовов, XML-метаданные, поиск по бизнес-именам, анализ документооборота, расширения (CFE) и многое другое.
