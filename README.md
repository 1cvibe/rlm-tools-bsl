...
32 BSL-специфичных хелпера + 8 стандартных I/O + 2 LLM = **42 хелпера**: навигация по модулям, парсинг процедур, граф вызовов, XML-метаданные, анализ документооборота, расширения (CFE) и многое другое.
...
Готовый промпт для комплексного E2E-теста всех 42 хелпера: **[docs/full_analysis_prompt.md](docs/full_analysis_prompt.md)**
