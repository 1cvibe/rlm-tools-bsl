...
28 BSL-специфичных хелперов + 8 стандартных I/O + 2 LLM = **38 хелперов**: навигация по модулям, парсинг процедур, граф вызовов, XML-метаданные, анализ документооборота, расширения (CFE) и многое другое.
...
Готовый промпт для комплексного E2E-теста всех 38 хелперов: **[docs/full_analysis_prompt.md](docs/full_analysis_prompt.md)**
